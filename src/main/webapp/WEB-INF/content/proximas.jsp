...
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link link-dark" href="${abiertas}"><s:text name="OpenSGSBean.text.opened"/></a>
    </li>
    <li class="nav-item">
        <a class="nav-link link-dark" href="${cerradas}"><s:text name="OpenSGSBean.text.closed"/></a>
    </li>
    <li class="nav-item">
        <a class="nav-link link-dark active" aria-current="page" href="${proximas}"><s:text name="OpenSGSBean.text.coming"/></a>
    </li>
</ul>
