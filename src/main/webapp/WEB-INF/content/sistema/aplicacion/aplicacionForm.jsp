...
<s:form action="%{actionName}" method="post" validate="true" theme="simple">
    ...
    <%@ include file="/WEB-INF/jspf/field/opening.jspf" %>
    
    <%@ include file="/WEB-INF/jspf/field/closing.jspf" %>

    <%@ include file="/WEB-INF/jspf/field/contact.jspf" %>
    
    <%@ include file="/WEB-INF/jspf/field/requestPerUser.jspf" %>
    
    <%@ include file="/WEB-INF/jspf/field/totalRequests.jspf" %>
    
    <%@ include file="/WEB-INF/jspf/field/applicationTemplate.jspf" %>
