...
<s:form action="%{actionName}!agregar" method="post" validate="true" theme="simple">
    ...
    <%@ include file="/WEB-INF/jspf/field/report.jspf" %>
...
<th><s:text name="OpenSGSBean.attribute.head"/></th>
<th><s:text name="OpenSGSBean.attribute.sqlStatement"/></th>
...
<s:iterator value="dtAplicacion.dtReportes" status="status">
    ...
    <td><s:property value="cabezal"/></td>
    <td><s:property value="sentenciaSQL"/></td>
