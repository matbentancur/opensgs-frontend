...
<s:form action="%{actionName}" method="post" validate="true" theme="simple">
    ...
    <%@ include file="/WEB-INF/jspf/field/operation.jspf" %>

    <%@ include file="/WEB-INF/jspf/field/element.jspf" %>

    <%@ include file="/WEB-INF/jspf/field/notificationDestination.jspf" %>

    <%@ include file="/WEB-INF/jspf/field/mailTemplate.jspf" %>
