...
<tr>
    <th><s:text name="OpenSGSBean.attribute.agreementText"/></th>
    <td><s:property value="dtOpenSGSManagedBean.textoAcuerdo"/></td>
</tr>

<tr>
    <th><s:text name="OpenSGSBean.attribute.deliveredText"/></th>
    <td><s:property value="dtOpenSGSManagedBean.textoEntrega"/></td>
</tr>
