...
<s:iterator value="listaDtOpenSGSManagedBeans" status="status">
    ...
    <td><s:property value="mantenimiento"/></td>
    <td><s:property value="cantidadMaximaUsuarios"/></td>
    <td><s:property value="fileUploadMaxSize"/></td>
    <td><s:property value="correoSoporte"/></td>
    <td><s:property value="filesPath"/></td>
    <td><s:property value="dtServidorCorreo.nombre"/></td>
    <td><s:property value="dtServidorAplicaciones.nombre"/></td>
    <td><s:property value="dtServidorAutenticacion.nombre"/></td>
