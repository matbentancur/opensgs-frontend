...
<s:form action="%{actionName}" method="post" validate="true" theme="simple">
    ...
    <%@ include file="/WEB-INF/jspf/solicitudes/paginas/field/genero.jspf" %>

    <%@ include file="/WEB-INF/jspf/solicitudes/paginas/field/fechaNacimiento.jspf" %>

    <%@ include file="/WEB-INF/jspf/solicitudes/paginas/field/nacionalidad.jspf" %>

    <%@ include file="/WEB-INF/jspf/solicitudes/paginas/field/departamentoPaisResidencia.jspf" %>
