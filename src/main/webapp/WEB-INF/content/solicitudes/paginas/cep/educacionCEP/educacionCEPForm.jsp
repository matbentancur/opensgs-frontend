...
<s:form action="%{actionName}" method="post" validate="true" theme="simple">
    ...
    <%@ include file="/WEB-INF/jspf/solicitudes/paginas/field/ultimoNivelEducativo.jspf" %>
    
    <%@ include file="/WEB-INF/jspf/solicitudes/paginas/field/tituloGrado.jspf" %>
    
    <%@ include file="/WEB-INF/jspf/solicitudes/paginas/field/anioRecibio.jspf" %>
    
    <%@ include file="/WEB-INF/jspf/solicitudes/paginas/field/institucionTitulo.jspf" %>
