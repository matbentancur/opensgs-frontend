...
<s:form action="%{actionName}" method="post" validate="true" theme="simple">
    ...
    <%@ include file="/WEB-INF/jspf/solicitudes/paginas/field/situacion.jspf" %>
    
    <%@ include file="/WEB-INF/jspf/solicitudes/paginas/field/departamentoTrabaja.jspf" %>
    
    <%@ include file="/WEB-INF/jspf/solicitudes/paginas/field/lugarTrabajo.jspf" %>
