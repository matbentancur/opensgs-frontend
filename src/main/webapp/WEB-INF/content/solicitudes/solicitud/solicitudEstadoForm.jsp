...
<%@ include file="/WEB-INF/jspf/navigation/solicitudes/navigationSolicitudEstadoForm.jspf" %>
...
<s:form action="%{actionName}" method="post" validate="true" theme="simple">
    ...
    <%@ include file="/WEB-INF/jspf/field/delivered.jspf" %> 

    <%@ include file="/WEB-INF/jspf/field/financed.jspf" %> 

    <%@ include file="/WEB-INF/jspf/field/completed.jspf" %> 

    <%@ include file="/WEB-INF/jspf/field/approved.jspf" %> 
