...
<tr>
    <th><s:text name="OpenSGSBean.attribute.agreement"/></th>
    <td>
        <s:if test="%{dtOpenSGSManagedBean.acordado}">
...
<tr>
    <th><s:text name="OpenSGSBean.attribute.agreementDate"/></th>
    <td><s:property value="dtOpenSGSManagedBean.acordadoFecha"/></td>
</tr>
